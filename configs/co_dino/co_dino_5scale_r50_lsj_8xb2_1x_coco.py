...
custom_imports = dict(
    imports=['configs.codetr'], allow_failed_imports=False)
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            ...
            ann_file='train/annotation_coco.json', data_prefix=dict(img='train/'),
        )
    ))
...
val_dataloader = dict(dataset=dict(pipeline=test_pipeline, data_root=data_root, metainfo=metainfo,
                                   ann_file='val/annotation_coco.json', data_prefix=dict(img='val/')
                                   ))
